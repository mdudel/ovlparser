 ...
 *         &lt;/element>
 *         &lt;element ref="{}HEIGHT"/>
 *         &lt;element ref="{}AUTO_OFF_TOGGLE" minOccurs="0"/>
 *         &lt;element ref="{}HOT_X"/>
 *         &lt;element ref="{}HOT_Y"/>
...
@XmlType(name = "bitmapType", propOrder = {
    "name",
    "description",
    "remarks",
    "maxscale",
...
public class BitmapType {
    ...
    @XmlElement(name = "AUTO_OFF_TOGGLE", defaultValue = "false")
    protected Boolean autoofftoggle;
    @XmlElement(name = "HOT_X")
    protected int hotx;
    @XmlElement(name = "HOT_Y")
    protected int hoty;
    ...
    /**
     * Gets the value of the autoofftoggle property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isAUTOOFFTOGGLE() {
        return autoofftoggle;
    }

    /**
     * Sets the value of the autoofftoggle property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setAUTOOFFTOGGLE(Boolean value) {
        this.autoofftoggle = value;
    }

    /**
     * Gets the value of the hotx property.
     * 
     */
    public int getHOTX() {
        return hotx;
    ...
    /**
     * Sets the value of the hotx property.
     * 
     */
    public void setHOTX(int value) {
        this.hotx = value;
    }

    /**
     * Gets the value of the hoty property.
     * 
     */
    public int getHOTY() {
        return hoty;
    ...
    /**
     * Sets the value of the hoty property.
     * 
     */
    public void setHOTY(int value) {
        this.hoty = value;
    }
